...
function placeMark() {
	...
	id += 1; //after first placement a +1 will be added to the left or prior operand.  This results in a mark in the 2nd box.  If the value was set at +=2 the second mark would be in the 3rd box, then 5th box...
